...
- **Do** deixar todo controle com foco de teclado visível: contorno sólido de 2px em ciano-petróleo com 2px de folga em botões e links; em campos, a borda ciano mais um contorno de 1px por fora. Navegação que parece botão é um só elemento (link estilizado), nunca um botão dentro de um link.
